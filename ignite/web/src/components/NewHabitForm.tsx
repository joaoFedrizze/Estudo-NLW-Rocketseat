      ...
      <div className="flex flex-col gap-2 mt-3">
        {availableWeeksDays.map((WeekDay, index) => (
          <AppCheckBox
            ...
            checkList={weekDays}
            checkListValue={index}
            checked={weekDays?.includes(index)}
          />
        ))}
      </div>

      <button type="submit" className="mt-6 rounded-lg p-4 flex item-center gap-3 font-semibold bg-green-600 justify-center hover:bg-green-500 ">
